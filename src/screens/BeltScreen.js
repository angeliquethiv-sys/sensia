      ...
      <div style={{ padding: '0 16px' }}>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', justifyContent: 'center', marginBottom: 20 }}>
            <BeltSVG centerLed={centerLed} sidesLed={sidesLed} bottomLed={bottomLed} size={240} />
          </div>
          ...
          <div style={{ marginBottom: 12 }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 6 }}>
              <span style={{ fontSize: 12, color: 'rgba(255,255,255,.6)' }}>🔋 Batterie</span>
              <span style={{ fontSize: 12, fontWeight: 700, color: battery > 30 ? LED.ok : LED.alert }}>{battery}%</span>
            </div>
            <div style={{ height: 6, background: 'rgba(255,255,255,.15)', borderRadius: 3, overflow: 'hidden' }}>
              <div style={{ width: `${battery}%`, height: '100%', borderRadius: 3, background: battery > 30 ? `linear-gradient(90deg,${LED.ok},#3DD68C)` : `linear-gradient(90deg,${LED.alert},#FF7B7B)`, transition: 'width .5s ease' }}/>
            </div>
          </div>
        ...
        {/* ── BOUTONS ── */}
        <button
          onClick={() => navigate('/belt-tutorial')}
        ...
        <button
          onClick={() => navigate('/belt-progress')}
          style={{ width: '100%', padding: '16px', borderRadius: 50, border: '2px solid #7B5EA7', cursor: 'pointer', background: 'transparent', color: '#7B5EA7', fontSize: 15, fontWeight: 700, marginBottom: 10 }}
        >
          📊 Ma ceinture qui apprend →
        </button>
        <button
          onClick={() => navigate('/session-analysis')}
          style={{ width: '100%', padding: '14px', borderRadius: 50, border: '1.5px solid rgba(196,152,106,.4)', cursor: 'pointer', background: 'transparent', color: '#C4986A', fontSize: 14, fontWeight: 600 }}
        >
